...
// Fetch posts from IndexedDB for sport category
async function fetchSportPostsFromDB() {
    try {
        ...
        return await categoryIndex.getAll('sport');
    } catch (error) {
...
async function renderSportPosts() {
    ...
    posts = await fetchSportPostsFromDB();
    ...
    if (sortedPosts.length === 0) {
        postFeed.innerHTML = `
            <div class="empty-state">
                ...
                <h3>No sport posts yet</h3>
                <p>Be the first to share something in the Sport category</p>
